...
| --------------------------------------------------------------- | --------------------------------------------- | --------------------------------------------------------- | ------------------------------------------------- |
| React `@ai-sdk/react`                                           | Yes                           | Yes                                       | Yes                               |
| Vue.js `@ai-sdk/vue`                                            | Yes                           | Yes                                       | Yes                               |
| Svelte `@ai-sdk/svelte`                                         | Yes Chat                      | Yes Completion                            | Yes StructuredObject              |
| Angular `@ai-sdk/angular`                                       | Yes Chat                      | Yes Completion                            | Yes StructuredObject              |
| [SolidJS](https://github.com/kodehort/ai-sdk-solid) (community) | Yes                           | Yes                                       | Yes                               |
